...
export const Bio = {
  ...
  resume:
    "https://drive.google.com/file/d/1x7BN_aPmwZ0M61aQgGOZftQtd6DjU5R7/view?usp=sharing",
...
export const experiences = [
  ...
  },
  {
    ...
    desc: `I had the opportunity to work across all phases of the SDLC for healthcare applications, ensuring compliance with data privacy and security regulations while utilizing Agile and Scrum methodologies. I developed single-page applications (SPAs) for healthcare portals using Angular, TypeScript, and RxJS. I also led the development of microservices with Java and Spring, incorporating Spring MVC, Spring Boot, and Spring Cloud, and integrated Spring Data JPA with Hibernate 5.x for efficient data management. Additionally, I launched scalable, cloud-based solutions on AWS (EC2, VPC, RDS, S3) and implemented Test-Driven Development (TDD) using Selenium and Mockito. My experience included streamlining build and deployment processes with Maven, Jenkins, and Docker.`,
  skills: [
  "Java",
  "Angular",
  "Spring Boot",
  ...
  {
    id: 2,
    img: "https://mma.prnewswire.com/media/690233/Mphasis_Logo.jpg?p=twitter",
    role: "Java Developer",
    company: "Mphasis",
    date: "April 2017 - March 2018",
    desc: `I developed responsive web applications for insurance services using React, HTML, CSS, JavaScript, JSP, and Bootstrap, focusing on user experience and optimized load times. I architected Spring MVC applications that featured robust transaction management and validation while utilizing Java SE 8 and multithreading for enhanced backend performance in high-volume claims processing. I improved database efficiency with JPA, Hibernate, and XML Schema configurations and designed scalable systems on AWS (EC2, S3, RDS, Lambda). Additionally, I led cross-functional teams to implement CI/CD pipelines with Jenkins and Git, automating testing and deployment processes for greater delivery efficiency.
    `,
    skills: [
      "Java",
      "JavaScript",
